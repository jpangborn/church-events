# Church Events for Kirby End User License Agreement

This End User License Agreement (the "Agreement") is a binding legal agreement between you and Joshua Pangborn (the "Author"). By installing or using Church Events for Kirby (the "Software"), you agree to be bound by the terms of this Agreement. If you do not agree to the Agreement, do not download, install, or use the Software. Installation or use of the Software signifies that you have read, understood, and agreed to be bound by the Agreement.
...
Technical support is provided as described on <https://github.com/jpangborn/church-events>. No representations or guarantees are made regarding the response time in which support questions are answered.
